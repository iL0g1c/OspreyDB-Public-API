# Program Overview
At OspreyX, we take the security of our users' data seriously. We encourage security researchers to help us identify vulnerabilities in our API. In return for your responsible disclosure, we offer up to 5 dollars and various swag in the GeoFS Open Source Community Server based on the severity of the impact.
...
|----------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|
| Critical | 9.0 - 10.0 | Remote Code Execution (RCE) or gaining write/delete access to the MongoDB database. Finding a way to leak the .env file containing DATABASE_TOKEN or DASHBOARD_TOKEN.                                                                                    | $10 + Hacker Overlord Role + Hall of Fame |
